...
function get_sift_for_woocommerce_sift_settings() {
	...
	$settings = array(
		...
		'actions_enabled'  => array(
			'name' => __( 'Enable Automated Actions', 'sift-for-woocommerce' ),
			'type' => 'checkbox',
			'desc' => __( 'Enable/disable the automated processing of fraud abuse decisions from Sift', 'sift-for-woocommerce' ),
			'id'   => 'wc_sift_for_woocommerce_automated_actions_enabled',
		),
		'section_end'      => array(
			'type' => 'sectionend',
