...
class Sift_For_WooCommerce {
	 ...
	 * via the filter hook, which takes the current block status first
	 * and the user ID second.
	 *
	...
	public static function has_new_purchase_block( $user_id ): bool {
		return apply_filters( 'sift_for_woocommerce_has_new_purchase_block', false, $user_id );
	}
}
